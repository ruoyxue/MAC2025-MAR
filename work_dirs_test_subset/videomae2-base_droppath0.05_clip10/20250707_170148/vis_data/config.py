...
test_evaluator = [
    ...
    dict(
        out_file_path=
        '/home/xueruoyao/MAC2025/MAR/work_dirs_test_subset_continue/videomae2-base_droppath0.05_clip10/result.pkl',
        type='DumpResults'),
]
test_pipeline = [
    dict(io_backend='disk', type='DecordInit'),
...
work_dir = '/home/xueruoyao/MAC2025/MAR/work_dirs_test_subset_continue/videomae2-base_droppath0.05_clip10'
