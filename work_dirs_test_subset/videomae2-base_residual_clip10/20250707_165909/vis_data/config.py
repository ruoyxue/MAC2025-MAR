...
test_evaluator = [
    ...
    dict(
        out_file_path=
        '/home/xueruoyao/MAC2025/MAR/work_dirs_test_subset_continue/videomaev2_base_res_clip10/result.pkl',
        type='DumpResults'),
]
test_pipeline = [
    dict(io_backend='disk', type='DecordInit'),
...
work_dir = '/home/xueruoyao/MAC2025/MAR/work_dirs_test_subset_continue/videomaev2_base_res_clip10'
